---
title: "sf-platform-parity"
slug: "sf-platform-parity"
tagline: "Keep product expectations and technical implementation aligned across every supported platform."
summary: "Audits platform parity, separates legitimate platform adaptations from implementation debt, and routes missing work to the right ShipFlow skill."
...
what_you_get:
  ...
  - "Routes to sf-spec, sf-build, sf-test, sf-verify, sf-docs, or sf-ship"
example_prompts:
  - "/sf-platform-parity overlay and hotkeys across desktop"
  - "/sf-platform-parity WinFlowz platforms=android,ios,windows,macos,linux,web"
  - "/sf-platform-parity check the platform claims before ship"
argument_modes:
...
Use `sf-platform-parity` when the product promise spans multiple platforms and
