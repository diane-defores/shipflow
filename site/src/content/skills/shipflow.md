...
outcome: "You get one first command that either answers directly or routes the current thread to the right ShipFlow skill with one numbered clarification question when needed."
