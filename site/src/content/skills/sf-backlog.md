...
when_to_use:
  ...
  - "When you want to preserve optional work without switching focus"
what_you_give:
  - "An idea, follow-up, or non-urgent task"
...
example_prompts:
  - "/sf-backlog add self-serve onboarding ideas"
  - "/sf-backlog revisit pricing proof section later"
  - "/sf-backlog capture SEO experiments"
limits:
