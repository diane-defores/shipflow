---
title: "sf-product-entitlements"
slug: "sf-product-entitlements"
...
example_prompts:
  - "/sf-product-entitlements define access checks for a new paid plan"
  - "/sf-product-entitlements audit duplicate entitlement tables before implementation"
  - "/sf-product-entitlements route a refund + sync scenario for product-local data"
  - "/sf-product-entitlements support runbook for code redemption and duplicate account access"
limits:
  ...
  - "It does not replace sf-build, sf-local-cloud-sync, sf-auth-debug, or product-specific implementation specs"
related_skills:
  - "sf-local-cloud-sync"
  - "sf-auth-debug"
  - "sf-spec"
...
Use `sf-product-entitlements` when access decisions are involved.
