...
docs_impact: yes
linked_systems:
  - shipflow_data/technical/agent-clarity-pass-playbook.md
  - shipflow_data/technical/skill-runtime-and-lifecycle.md
  - shipflow_data/workflow/specs/agent-clarity-pass-playbook-and-checklist.md
depends_on:
  - artifact: "shipflow_data/technical/agent-clarity-pass-playbook.md"
    artifact_version: "1.0.0"
    required_status: "active"
supersedes: []
evidence:
  - "Checklist created after the 2026-06 multi-phase clarity campaign to make future sweeps repeatable."
next_step: "/009-sf-skill-build start the next bounded agent-clarity phase with this checklist"
---
...
| ACP-007 | Shared taxonomy | The shared taxonomy doc was updated when family wording changed. | yes | `shipflow_data/technical/skill-runtime-and-lifecycle.md` reflects the same boundaries as the local skills. | NOT_RUN |  |  |  |  |
