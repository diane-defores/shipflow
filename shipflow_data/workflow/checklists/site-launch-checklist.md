...
linked_systems:
  ...
  - shipflow_data/workflow/playbooks/site-launch-playbook.md
depends_on:
  - artifact: "shipflow_data/workflow/playbooks/site-launch-playbook.md"
    artifact_version: "1.0.0"
...
next_step: "/300-sf-docs migrate additional launch checklists into workflow/checklists"
---
...
- [site-launch-playbook.md](/home/claude/shipflow/shipflow_data/workflow/playbooks/site-launch-playbook.md)
...
```bash
python3 /home/claude/shipflow/tools/shipflow_metadata_lint.py /home/claude/shipflow/shipflow_data/workflow/checklists/site-launch-checklist.md
```
