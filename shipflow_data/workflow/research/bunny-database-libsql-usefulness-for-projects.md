...
Store normalized research items from `shipflow_data/workflow/research/` and veille notes: tool name, project relevance, score, category, source URL, decision, revisit date.
...
Spec recommandee: /100-sf-spec Pilot Bunny Database for low-risk project metadata
