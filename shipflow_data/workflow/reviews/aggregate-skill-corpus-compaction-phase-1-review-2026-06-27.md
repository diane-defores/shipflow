...
docs_impact: yes
linked_systems:
  - shipflow_data/workflow/specs/aggregate-skill-corpus-compaction-phase-1.md
...
depends_on:
  - artifact: "shipflow_data/workflow/specs/aggregate-skill-corpus-compaction-phase-1.md"
    artifact_version: "1.0.0"
    required_status: "reviewed"
supersedes: []
evidence:
  - "`503-sf-audit-design-tokens` now keeps the activation contract compact and loads the deep audit detail from a local reference."
...
- The deep design-tokens audit detail no longer competes with the first-screen activation contract in `503-sf-audit-design-tokens`.
