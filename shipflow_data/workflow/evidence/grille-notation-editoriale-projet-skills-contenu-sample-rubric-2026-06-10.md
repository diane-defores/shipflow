...
evidence:
  ...
  - "Content quality rubric defines schema, final statuses, blocked reason codes, and sf-verify consumption rules."
next_step: "/sf-end grille notation editoriale projet skills contenu"
---
...
- Source refs: `shipflow_data/business/business.md`, `shipflow_data/business/product.md`, `shipflow_data/business/branding.md`, `shipflow_data/editorial/claim-register.md`.
...
```json
{
  ...
  "applied_rules_revision": {
    "business": "shipflow_data/business/business.md@1.2.0",
  ...
  "evidence": [
    {
      ...
      "source": "shipflow_data/business/product.md",
      "state": "pass"
    },
    {
      "criterion": "brand_voice",
      "source": "shipflow_data/business/branding.md",
      "state": "pass"
    },
    {
...
Consumption verdict: valid final rubric output, consumable by `sf-verify` as evidence for a non-blocked but not-yet-ready revision state.
...
The sample evidence demonstrates that `sf-verify` can consume valid final rubric outputs, distinguish revision from blocked states, and reject sensitive claim failures even when the global score is not low.
