...
linked_systems:
  ...
  - "shipflow_data/workflow/specs/grille-notation-editoriale-projet-skills-contenu.md"
depends_on:
  - artifact: "skills/references/content-quality-rubric.md"
    artifact_version: "1.0.0"
    required_status: "active"
  - artifact: "shipflow_data/workflow/specs/grille-notation-editoriale-projet-skills-contenu.md"
    artifact_version: "1.0.0"
...
This artifact proves that the shared content quality rubric can produce a schema-complete editorial score and that `sf-verify` has concrete examples for rejecting non-final or incoherent score states.
...
```json
{
  ...
  "input_refs": {
    "content_ref": "shipflow_data/workflow/specs/grille-notation-editoriale-projet-skills-contenu.md",
    "source_refs": [
      "skills/references/content-quality-rubric.md",
  ...
  "applied_rules_revision": {
    "business": "shipflow_data/business/*@1.2.0",
    "editorial": "shipflow_data/editorial/content-map.md@0.8.0",
    "claim_register": "shipflow_data/editorial/claim-register.md@1.1.0"
  },
  "scores": {
    "overall": 82,
    "clarity": 86,
  ...
  "evidence": [
    ...
    },
    {
      ...
      "source": "shipflow_data/business/* and shipflow_data/editorial/*",
      "state": "pass"
    },
    {
      "criterion": "claim support",
      "source": "shipflow_data/editorial/claim-register.md",
      "state": "warning"
    },
    {
...
Expected `sf-verify` result: reject with `duplicate_in_progress`.
...
Expected `sf-verify` result: reject with `conflicting_score_state`.
...
```json
{
  ...
  "applied_rules_revision": {
    "business": "shipflow_data/business/*@old",
    "editorial": "shipflow_data/editorial/content-map.md@old",
    "claim_register": "shipflow_data/editorial/claim-register.md@old"
  },
  "scores": {
    "overall": 88,
    "clarity": 90,
...
Expected `sf-verify` result: reject with `stale_or_mismatched_score`.
