...
next_step: "/sf-docs audit shipflow_data/GUIDELINES.md"
---

# GUIDELINES — shipflow_data

## Scope
These rules apply to `/home/claude/shipflow_data` and to any agent action that edits this workspace.
...
- Use absolute paths in links when referencing files from this workspace (`/home/claude/shipflow_data/...`).
...
- Link any newly important process to the relevant task in `/home/claude/shipflow_data/TASKS.md`.
