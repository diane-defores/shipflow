...
`contentflow_lab` est actif sur PM2. Je le traite comme laboratoire/backend de ContentFlow: pipelines, données, agents, sources et expérimentation. La veille canonique est dans `~/shipflow_data/projects/contentflow/concurrent.md`.
