...
- [ ] 🟠 Plan `/sf-migrate` for deprecated and major-line tracks before changing them: `@primevue/themes` → `@primeuix/themes`, PrimeVue 3 → 4, `unplugin-vue-router`/Vue Router 4 → Vue Router 5, plus Vite 8, Tailwind 4, Pinia 3, TypeScript 6, and ESLint 10.
