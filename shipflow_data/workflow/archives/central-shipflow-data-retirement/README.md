...
Ce dossier contient les artefacts de retraite du dépôt central `~/shipflow_data`.
...
- `shipflow_data-central-archive.bundle` : snapshot Git de l’historique de `~/shipflow_data`.
