...
linked_systems:
  ...
  - shipflow_data/workflow/checklists/README.md
  - skills/references/canonical-paths.md
  - skills/300-sf-docs/references/core-governance.md
depends_on:
  - artifact: "shipflow_data/workflow/checklists/README.md"
    artifact_version: "1.0.0"
...
evidence:
  ...
  - "Current corpus already stores test checklists under shipflow_data/workflow/test-checklists but lacks a canonical home for reusable domain playbooks."
next_review: "2026-07-05"
next_step: "/300-sf-docs update playbook migration inventory"
---

# Workflow Playbooks

`shipflow_data/workflow/playbooks/` is the canonical library for reusable operational playbooks that can apply across multiple projects, sites, apps, or business surfaces.
...
- durable business or technical truth that belongs in `shipflow_data/business/` or `shipflow_data/technical/`
...
```bash
python3 /home/claude/shipflow/tools/shipflow_metadata_lint.py /home/claude/shipflow/shipflow_data/workflow/playbooks/README.md
```
