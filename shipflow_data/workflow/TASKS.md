...
🟠 [ShipFlow] task: Durcir la clarté agent des frontières de rôle et du prochain owner sur les skills à plus forte ambiguïté | status: in progress | area: skills-agent-clarity | spec: shipflow_data/workflow/specs/agent-clarity-hardening-phase-4.md | source: decision utilisateur 2026-06-27 | next: /009-sf-skill-build continue agent-clarity hardening after the phase-4 pilot
