...
🟠 [ShipFlow] task: Compacter le corpus global des skills pour repasser sous le budget agrégé `8500` sans dégrader les garde-fous d'execution | status: todo | area: skills-corpus-compaction | source: skill_budget_audit.py 2026-06-27 | next: /009-sf-skill-build plan aggregate corpus compaction
