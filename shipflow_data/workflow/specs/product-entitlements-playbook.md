...
security_impact: yes
docs_impact: yes
user_story: "En tant qu'operatrice ShipFlow, je veux un playbook transverse pour les entitlements produit, afin que SocialGlowz, WinFlowz et les futurs projets ne confondent jamais compte utilisateur, paiement provider et acces produit."
linked_systems:
...
next_step: "/sf-start product-entitlements-playbook"
---
...
Create a reusable ShipFlow reference for product access, billing-provider boundaries, Lifetime Deal redemption, manual grants, refunds, revocations, support triage, and smoke-test proof.
...
|----------|-------|-------|--------|--------|-----------|
| 2026-05-29 23:39:28 UTC | sf-build | GPT-5 Codex | Created ready spec for a reusable ShipFlow product entitlements playbook. | implemented | `/sf-start product-entitlements-playbook` |
| 2026-05-29 23:40:53 UTC | sf-build | GPT-5 Codex | Implemented shared product entitlements playbook and linked it from the ShipFlow runtime/lifecycle technical reference. | implemented | `/sf-verify product-entitlements-playbook` |
| 2026-05-29 23:41:42 UTC | sf-build | GPT-5 Codex | Verified metadata lint, diff hygiene, and marketplace wording boundaries for the playbook. | implemented | `/sf-ship product-entitlements-playbook` |
| 2026-05-29 23:41:42 UTC | sf-end | GPT-5 Codex | Closed playbook documentation chantier with reference and technical lifecycle discoverability aligned. | closed | `/sf-ship product-entitlements-playbook` |
| 2026-05-29 23:41:54 UTC | sf-ship | GPT-5 Codex | Prepared bounded ship for the product entitlements playbook reference and spec. | shipped | `Adopt playbook in future billing/entitlement chantiers` |
