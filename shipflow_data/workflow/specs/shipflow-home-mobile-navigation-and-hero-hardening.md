...
user_story: "En tant que visiteur mobile du site ShipFlow, je veux une home plus lisible et mieux hiérarchisée, avec une navigation compacte et des espacements plus professionnels, pour comprendre l'offre sans friction ni sensation de maquette fragile."
owner: "Diane"
confidence: medium
risk_level: medium
...
linked_systems:
  ...
  - "shipflow_data/technical/public-site-and-content-runtime.md"
...
depends_on:
  ...
  - artifact: "shipflow_data/technical/public-site-and-content-runtime.md"
...
supersedes: []
next_step: "/102-sf-start ShipFlow home mobile navigation and hero hardening"
---

# Title

ShipFlow Home Mobile Navigation and Hero Hardening

## Status

Ready.

This chantier covers the mobile-first hardening of the public ShipFlow home so the page reads as operational and trustworthy rather than cute or oversized. The implementation must fix navigation, hero scale, spacing rhythm, and elevation through the existing site token layer instead of local visual patches.

## User Story

En tant que visiteur mobile du site ShipFlow, je veux une home plus lisible et plus structurée, avec un vrai menu compact, un hero moins massif, des espacements mieux contrôlés et une profondeur visuelle plus crédible, afin de comprendre rapidement la proposition de valeur et de naviguer sans friction.
...
- design-system declaration updates in `shipflow_data/technical/design-system-authority.md` if ShipFlow site authority is still missing
- verification checklist under `shipflow_data/workflow/test-checklists/`
...
- `shipflow_data/business/branding.md` sets the trust posture and visual direction.
- `shipflow_data/technical/design-system-authority.md` must declare the ShipFlow site authority if missing.

Downstream:

- `103-sf-verify` needs local build proof plus browser/mobile evidence.
- `104-sf-end` must record docs/editorial impact and proof status before any ship decision.

## Documentation Coherence

- Update `shipflow_data/technical/design-system-authority.md` if the ShipFlow site authority is missing or incomplete.
- Update `shipflow_data/technical/public-site-and-content-runtime.md` only if navigation/runtime behavior changes in a way that affects public-site rules.
- Update `shipflow_data/editorial/content-map.md` only if the role of the landing page or cross-surface update rules materially change.
...
- [ ] Task 1: Formalize the chantier and proof surface
  - Files: `shipflow_data/workflow/specs/shipflow-home-mobile-navigation-and-hero-hardening.md`, `shipflow_data/workflow/test-checklists/shipflow-home-mobile-navigation-and-hero-hardening.md`
  - Action: create the spec/checklist pair and define proof obligations through `104-sf-end`.
...
- [ ] Task 5: Update design-system authority if needed
  - Files: `shipflow_data/technical/design-system-authority.md`
  - Action: declare ShipFlow site token authority so future UI work does not infer it.
...
- [ ] Task 6: Run implementation proof and closure
  ...
  - Action: run build, drift check, browser/mobile proof, then update checklist and chantier flow through `104-sf-end`.
...
- [ ] AC-5: `npm --prefix site run build` passes.
...
- surface: ShipFlow public home and shared top navigation
...
- proof_order:
  ...
  2. `npm --prefix site run build`
  3. browser/mobile proof on `/` and `/fr/`
- checklist_path: `shipflow_data/workflow/test-checklists/shipflow-home-mobile-navigation-and-hero-hardening.md`
...
- `python3 /home/claude/shipflow/tools/shipflow_metadata_lint.py /home/claude/shipflow/shipflow_data/workflow/specs/shipflow-home-mobile-navigation-and-hero-hardening.md /home/claude/shipflow/shipflow_data/workflow/test-checklists/shipflow-home-mobile-navigation-and-hero-hardening.md`
...
|----------|-------|-------|--------|--------|-----------|
| 2026-06-12 20:33:21 UTC | 100-sf-spec | GPT-5 Codex | create | ready | /101-sf-ready ShipFlow home mobile navigation and hero hardening |
| 2026-06-12 20:33:21 UTC | 101-sf-ready | GPT-5 Codex | readiness-check | ready | /102-sf-start ShipFlow home mobile navigation and hero hardening |
| 2026-06-12 20:40:49 UTC | 001-sf-build | GPT-5 Codex | delegated implementation, verification, and closure without ship | implemented | stop before /005-sf-ship per user request |
