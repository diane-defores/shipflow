...
- [ ] Port `shipflow-main` so references resolve inside the plugin rather than `$HOME/shipflow`.
- [ ] Copy only required shared references, skill-local references, templates, and scripts for `shipflow-main`.
