...
owner: "Diane"
user_story: "As the ShipFlow operator, I want core skill boundaries and next-owner routing to stay obvious to fresh agents under pressure, so they do not confuse implement vs verify vs close vs ship, or manual QA vs browser vs auth debugging."
confidence: high
risk_level: high
security_impact: yes
docs_impact: yes
...
supersedes: []
next_step: "/009-sf-skill-build continue agent-clarity hardening after the phase-1 pilot"
---
...
As the ShipFlow operator, I want core skill boundaries and next-owner routing to stay obvious to fresh agents under pressure, so they do not confuse implement vs verify vs close vs ship, or manual QA vs browser vs auth debugging.
...
- `102-sf-start`, `103-sf-verify`, `104-sf-end`, and `005-sf-ship` each expose a one-question contract and a clean owner boundary.
- `108-sf-browser` and `109-sf-auth-debug` keep one-screen clarity about when they must reroute instead of continuing.
...
- `tools/shipflow_sync_skills.sh --check --skill 005-sf-ship`
- `tools/shipflow_sync_skills.sh --check --skill 102-sf-start`
- `tools/shipflow_sync_skills.sh --check --skill 103-sf-verify`
- `tools/shipflow_sync_skills.sh --check --skill 104-sf-end`
- `tools/shipflow_sync_skills.sh --check --skill 108-sf-browser`
