...
owner: "Diane"
user_story: "As the ShipFlow operator, I want public and repo-visible help surfaces to state clear handoff boundaries, so fresh agents and humans know when a surface explains, routes, invokes, or owns execution across help docs, runtime docs, and cheatsheets."
confidence: high
risk_level: medium
security_impact: no
docs_impact: yes
...
depends_on:
  - artifact: "shipflow_data/workflow/specs/agent-clarity-hardening-phase-7.md"
    artifact_version: "1.0.0"
    required_status: "ready"
  - artifact: "shipflow_data/workflow/specs/agent-clarity-pass-playbook-and-checklist.md"
    artifact_version: "1.0.0"
...
As the ShipFlow operator, I want public and repo-visible help surfaces to state clear handoff boundaries, so fresh agents and humans know when a surface explains, routes, invokes, or owns execution across help docs, runtime docs, and cheatsheets.
...
- `skills/302-sf-help/SKILL.md` and `skills/302-sf-help/references/help-catalog.md` make the help boundary and next-owner routing explicit in examples that fresh agents are likely to copy.
- `shipflow_data/technical/skill-runtime-and-lifecycle.md` documents the public/docs handoff taxonomy so future edits preserve `explains vs routes vs invokes vs owns execution`.
...
- If examples blur `000-shipflow`, `302-sf-help`, `706-continue`, or owner lifecycle skills, reject it.
...
- no new workflow ownership changes in `skills/000-shipflow`, `001-sf-build`, or other execution skills unless docs reveal a contradiction that must be split into a separate chantier
...
- `python3 tools/shipflow_metadata_lint.py shipflow_data/workflow/specs/agent-clarity-public-docs-handoffs-phase-2.md shipflow_data/technical/skill-runtime-and-lifecycle.md README.md shipflow-spec-driven-workflow.md docs/skill-launch-cheatsheet.md skills/302-sf-help/references/help-catalog.md`
...
- [x] Clarify `302-sf-help` and its help catalog so examples expose the correct owner boundary.
...
|----------|-------|-------|--------|--------|-----------|
| 2026-06-28 | 009-sf-skill-build | GPT-5 Codex | Create phase-2 spec for public/docs handoff clarity and bind the runtime-pages backlog slice under it | implemented | Run the documentation-owner pass through `300-sf-docs` |
...
- `101-sf-ready` ✅ ready with bounded public/docs scope
