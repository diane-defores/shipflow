...
user_story: "En tant qu'operatrice ShipFlow, je veux une application et un site ContentGlowz qui restent strictement alignes sur un systeme de tokens commun, avec aucune personnalisation visuelle locale sans source autorisee."
owner: "Diane"
confidence: medium
risk_level: high
...
evidence:
  ...
  - "contentglowz has explicit token sources (`contentglowz_theme.json`, `app_theme_tokens.dart`) but no shipped `shipflow_data/technical/design-system-authority.md` inside the project repo."
...
supersedes: []
next_step: "/102-sf-start ContentGlowz app/site token hardening and visual standardization"
---
...
En tant qu'operatrice ShipFlow, je veux une coherence visuelle professionnelle et durable entre le site et l'application ContentGlowz sans personnalisation visuelle improvisée.
...
- `005-sf-ship` and `103-sf-verify` require hardening checks passing before finalization.

Upstream:
- Must align with `shipflow_data/technical/design-system-authority.md` and `skills/references/design-system-token-contract.md`.
...
- [ ] Task 1: Declare and lock the canonical visual source for both surfaces
  - Files: `/home/claude/contentglowz/contentglowz_theme.json`, `shipflow_data/technical/design-system-authority.md`
...
- [ ] Task 6: Add/align anti-literal gate for both surfaces
  - Files: `/home/claude/contentglowz/tools/check_design_tokens.mjs`, `shipflow_data/technical/design-system-authority.md`
...
- [ ] Task 7: Validate responsiveness and finish proof
  ...
  - Validate with: `103-sf-verify` and completed manual checklist.
...
- proof_order:
  ...
  5. `103-sf-verify`
- checklist_path: `shipflow_data/workflow/test-checklists/contentglowz-app-site-token-hardening-and-visual-standardization.md`
...
- `python3 /home/claude/shipflow/tools/shipflow_metadata_lint.py shipflow_data/workflow/specs/contentglowz-app-site-token-hardening-and-visual-standardization.md shipflow_data/workflow/test-checklists/contentglowz-app-site-token-hardening-and-visual-standardization.md`
...
| 2026-06-11 18:17:00 UTC | 102-sf-start | GPT-5 Codex | implementation-start | in-progress | /102-sf-start ContentGlowz app/site token hardening and visual standardization |

## Current Chantier Flow

- 100-sf-spec: done
- 101-sf-ready: done
- 102-sf-start: in-progress
