...
evidence:
  ...
  - "Existing skills `007-sf-content`, `200-sf-redact`, `202-sf-repurpose`, `206-sf-audit-copy`, and `207-sf-audit-copywriting` cover adjacent copy/content work but do not own sequence-specific email orchestration."
next_step: "/102-sf-start shipflow_data/workflow/specs/emailing-sequences-audience-skill.md"
---
...
As a ShipFlow user who sends email sequences to an audience, I want a dedicated `emailing` skill that helps me design, write, and review multi-step campaigns, so I can produce consistent sequences with clear cadence, audience fit, and measurable outcomes without treating the work like one-to-one mail.
...
ShipFlow has strong adjacent content and copy skills, but none of them owns the operator intent “I need an email sequence for my audience.” Without a dedicated skill, sequence work gets blurred into article drafting or generic copy review, which hides cadence, segmentation, opt-out, and campaign-level decision making.
...
- Read first: `skills/007-sf-content/SKILL.md`, `skills/200-sf-redact/SKILL.md`, `skills/202-sf-repurpose/SKILL.md`, `skills/206-sf-audit-copy/SKILL.md`, `skills/207-sf-audit-copywriting/SKILL.md`.
...
- Preserve claim evidence and product governance when referencing ShipFlow products.
...
- [x] Task 2: Keep the skill aligned with adjacent content and copy owners.
  - File: `skills/emailing/SKILL.md`
  - Action: Route supporting work to `007-sf-content`, `200-sf-redact`, `202-sf-repurpose`, `206-sf-audit-copy`, or `207-sf-audit-copywriting` when the brief is upstream or adjacent.
  - User story link: Prevents duplication and keeps the new skill bounded.
  - Depends on: Task 1
  - Validate with: `rg -n "007-sf-content|200-sf-redact|202-sf-repurpose|206-sf-audit-copy|207-sf-audit-copywriting" skills/emailing/SKILL.md`

## Skill Run History

| Date UTC | Skill | Model | Action | Result | Next step |
|----------|-------|-------|--------|--------|-----------|
| 2026-06-27 06:39:00 UTC | 100-sf-spec | GPT-5 Codex | Created the durable contract for the new `emailing` skill. | ready | `/101-sf-ready shipflow_data/workflow/specs/emailing-sequences-audience-skill.md` |
| 2026-06-27 09:27:00 UTC | 101-sf-ready | GPT-5 Codex | Reviewed the spec and found missing readiness sections, so it was not yet ready. | not ready | add acceptance, test, risks, execution notes, and open questions |
| 2026-06-27 11:31:00 UTC | 102-sf-start | GPT-5 Codex | Implemented the `emailing` skill contract for audience email sequences. | implemented | `/103-sf-verify shipflow_data/workflow/specs/emailing-sequences-audience-skill.md` |
| 2026-06-27 09:27:00 UTC | 100-sf-spec | GPT-5 Codex | Completed the readiness repair for the `emailing` spec after `101-sf-ready` identified missing sections. | ready | `/102-sf-start shipflow_data/workflow/specs/emailing-sequences-audience-skill.md` |
| 2026-06-27 11:37:00 UTC | 103-sf-verify | GPT-5 Codex | Verified the `emailing` skill contract, runtime links, and spec coherence for audience email sequences. | verified | `/104-sf-end shipflow_data/workflow/specs/emailing-sequences-audience-skill.md` |
| 2026-06-27 11:40:00 UTC | 104-sf-end | GPT-5 Codex | Closed the chantier after implementation and verification, with no tracker or changelog delta required. | closed | none |
...
- Current spec: `shipflow_data/workflow/specs/emailing-sequences-audience-skill.md`.
