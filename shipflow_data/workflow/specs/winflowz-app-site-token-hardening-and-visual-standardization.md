...
user_story: "En tant qu'operatrice ShipFlow, je veux une interface app/site WinFlowz strictement alignée sur un jeu de tokens unifié, sans valeurs visuelles locales non autorisees."
owner: "Diane"
confidence: high
risk_level: high
...
linked_systems:
  ...
  - "shipflow_data/technical/winflowz_app/guidelines.md"
...
En tant qu'operatrice ShipFlow, je veux une experience WinFlowz professionnelle et cohérente, avec un contrat visuel unique pour app et site.
...
- Keep design-token contracts and exceptions in `shipflow_data/technical/design-system-authority.md` and this spec.
...
- [ ] Task 1: Lock cross-surface visual source and exception policy
  - Files: `shipflow_data/technical/design-system-authority.md`, `winflowz_app/lib/core/theme/winflowz_theme_tokens.dart`, `winflowz_site/src/assets/styles/global.css`
...
- [ ] Task 4: Add drift and consistency gate checks
  - Files: `shipflow_data/workflow/specs/winflowz-app-site-token-hardening-and-visual-standardization.md`, `shipflow_data/workflow/test-checklists/winflowz-app-site-token-hardening-and-visual-standardization.md`
...
- [ ] Task 5: Hardening verification and close
  - Files: `winflowz_app`, `winflowz_site`, `shipflow_data/workflow/*`
...
- proof_order:
  ...
  6. `103-sf-verify`
- checklist_path: `shipflow_data/workflow/test-checklists/winflowz-app-site-token-hardening-and-visual-standardization.md`
