...
depends_on: []
supersedes: []
next_step: "/100-sf-spec role references for agent posture"
---
...
- `shipflow_data/technical/context.md` - current skill workflow, focus tag implications, and owner routing model.
- `README.md` - public explanation of skills, focus tags, and distribution.
- `skills/700-sf-explore/SKILL.md` - exploration mode and report threshold.
...
| --- | --- | --- | --- |
| Skill | `/007-sf-content` or `007-sf-content` | workflow and artifact outcome | write, audit, repurpose, publish content |
...
- Recommended next command: `/100-sf-spec role references for agent posture`
...
|----------|--------------|--------|--------|-----------|
| 2026-06-27 04:39:09 UTC | `%role` references for SEO/growth-style agent posture | Compared current skills, focus tags, subagent roles, and instruction layering | Recommended a bounded `%role` reference layer rather than new specialist skills | `/100-sf-spec role references for agent posture` |
