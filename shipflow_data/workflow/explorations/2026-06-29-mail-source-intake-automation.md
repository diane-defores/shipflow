...
depends_on:
  ...
  - artifact: "skills/references/private-memory-store.md"
    ...
    required_status: active
supersedes: []
next_step: "/100-sf-spec daily mail source intake automation"
---
...
- Recommended next command: `/100-sf-spec daily mail source intake automation`
