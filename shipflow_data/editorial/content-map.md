...
| Focus tags cheatsheet | `docs/focus-tags-cheatsheet.md`, `site/src/pages/docs.astro`, `site/src/pages/fr/docs.astro` | Explain the two public focus-tag families and how lightweight recentering tags reload the right contracts | Markdown artifact + Astro cards | `skills/references/shipflow-terms.md`, `skills/references/entrypoint-routing.md`, `skills/references/operator-partnership-contract.md`, `skills/references/decision-quality-contract.md`, `skills/008-sf-onboarding/SKILL.md`, `shipflow_data/business/gtm.md` | Tag inventory, tag families, or public recentering guidance changes |
