...
`/home/claude/shipflow_data` is the durable planning layer for ShipFlow operations.
...
For any tooling that reads `shipflow_data` and for cross-project onboarding, keep `/home/claude/shipflow_data/.env.example` current.
