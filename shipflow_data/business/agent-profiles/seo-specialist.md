...
next_step: "/103-sf-verify agent-profile-seo-specialist"
---
...
```text
000-shipflow profile=seo-specialist Quelle surface doit être corrigée en premier pour améliorer la découvrabilité ?
```
...
- `000-shipflow` decides the owner skill
