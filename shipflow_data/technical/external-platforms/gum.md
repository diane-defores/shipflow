...
depends_on:
  ...
  - artifact: "shipflow_data/technical/external-platforms/bash.md"
    artifact_version: "0.1.0"
    required_status: "draft"
supersedes: []
evidence:
...
- A project uses Gum materially but lacks `shipflow_data/technical/platforms/gum.md`.
...
```bash
python3 tools/shipflow_metadata_lint.py shipflow_data/technical/external-platforms/gum.md
rg -n "Freshness Gate|Source Map|ShipFlow Decision Rules|Maintenance Rule" shipflow_data/technical/external-platforms/gum.md
```
...
Update this note when Gum command behavior, install guidance, release behavior, ShipFlow TUI fallback policy, or menu validation rules change.
