...
linked_systems:
  ...
  - shipflow_data/workflow/specs/agent-clarity-hardening-phase-7.md
  - shipflow_data/workflow/reviews/skill-system-hardening-register.md
  - shipflow_data/workflow/test-checklists/agent-clarity-pass-checklist.md
depends_on:
...
next_step: "/009-sf-skill-build run the next bounded agent-clarity pass when ambiguity reappears"
---
...
This playbook captures how to run a future ShipFlow agent-clarity pass.
...
`shipflow_data/technical/skill-runtime-and-lifecycle.md` in the same slice.
...
tools/shipflow_sync_skills.sh --check --skill <each touched skill>
```
...
1. this playbook
2. `shipflow_data/workflow/test-checklists/agent-clarity-pass-checklist.md`
