...
| `skills/references/operator-roles/**`, `shipflow_data/business/agent-profiles/**` | Operator role and named profile layer | `shipflow_data/technical/skill-runtime-and-lifecycle.md` | `shipflow-spec-driven-workflow.md`, `skills/000-shipflow/SKILL.md`, `skills/302-sf-help/SKILL.md`, `shipflow_data/business/business.md` | Metadata lint for touched contracts/references; focused `rg` checks for `profile=`, `role_id`, and profile invocation examples | Named operator profile semantics, role arbitration rules, invocation syntax, or router/help discoverability changes |
