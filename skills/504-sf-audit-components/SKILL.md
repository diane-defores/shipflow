...
- Called by `502-sf-audit-design` in deep mode, or standalone via `/504-sf-audit-components`.
...
- `rg -n "Trace category|Process role|Chantier Potential|Report Modes|Mode Detection|Pre-check|component-audit-workflow|Validation" skills/504-sf-audit-components/SKILL.md`
- `python3 tools/skill_budget_audit.py --skills-root skills --format markdown`
- `python3 tools/shipflow_metadata_lint.py skills/504-sf-audit-components/references/component-audit-workflow.md`
