...
- **Appelée par** : `502-sf-audit-design` en deep mode (parallèle avec `503-sf-audit-design-tokens` et `409-sf-audit-a11y`).
- **Associée** : l'accessibilité des composants (focus management, ARIA patterns, keyboard nav) est couverte par `409-sf-audit-a11y` séparément — cette skill se concentre sur l'architecture.
...
# Cross-projet
/504-sf-audit-components global
```
