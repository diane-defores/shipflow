...
updated: "2026-06-10"
status: active
source_skill: 504-sf-audit-components
...
supersedes: []
evidence:
  - "Extracted from 504-sf-audit-components/SKILL.md during residual body-risk cleanup."
next_step: "none"
---

# Component Audit Workflow

Use this reference after the top-level `504-sf-audit-components` activation contract has selected PROJECT, FILE, or GLOBAL mode.
