...
updated: "2026-06-10"
status: active
source_skill: sf-audit-components
...
supersedes: []
evidence:
  - "Extracted from sf-audit-components/SKILL.md during residual body-risk cleanup."
next_step: "none"
---

# Component Audit Workflow

Use this reference after the top-level `sf-audit-components` activation contract has selected PROJECT, FILE, or GLOBAL mode.
