...
Load `$SHIPFLOW_ROOT/skills/sf-audit-components/references/component-audit-workflow.md` after the context pre-check passes. It contains the detailed project/file/global audit playbook, cross-platform adaptations, severity rules, tracking writes, and report matrix.
...
- Project-local `shipflow_data/workflow/TASKS.md`: mirror the same traffic-first task records under the project when applicable.
...
- `rg -n "Trace category|Process role|Chantier Potential|Report Modes|Mode Detection|Pre-check|component-audit-workflow|Validation" skills/sf-audit-components/SKILL.md`
- `python3 tools/skill_budget_audit.py --skills-root skills --format markdown`
- `python3 tools/shipflow_metadata_lint.py skills/sf-audit-components/references/component-audit-workflow.md`
