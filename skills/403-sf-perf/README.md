...
`403-sf-perf` reviews the parts of a product that usually get slow quietly: bundle weight, rendering patterns, hydration, data fetching, asset handling, and Core Web Vitals readiness. It can focus on a single file, a whole project, or multiple projects in one workspace.
...
/403-sf-perf
/403-sf-perf global
/403-sf-perf src/pages/pricing.tsx
```
...
- `105-sf-check` after fixes
- `502-sf-audit-design` when UX and rendering concerns overlap
- `405-sf-prod` to validate the deployed result
