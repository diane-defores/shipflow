...
- **Appelée par** : `502-sf-audit-design` en deep mode (parallèle avec `503-sf-audit-design-tokens` et `504-sf-audit-components`).
- **Complémentaire à** : `504-sf-audit-components` — celle-ci audite l'architecture des composants, cette skill audite leur accessibilité. Les deux ensemble donnent une vision complète.
