...
linked_systems:
  ...
  - skills/400-sf-audit/references/audit-master-workflow.md
depends_on:
...
This reference preserves the detailed pre-compaction instructions for `400-sf-audit`. The top-level `SKILL.md` is now the activation contract; load this file only when the selected mode needs the detailed workflow, checklist, templates, provider routing, examples, or report details below.
...
- `$HOME/.codex/skills/403-sf-perf/SKILL.md`
