...
`400-sf-audit` is the master audit entrypoint. It orchestrates the specialist audits across code, design, copy, SEO, go-to-market, translation, dependencies, and performance, then consolidates the results into one report.
...
```bash
/400-sf-audit
/400-sf-audit src/pages/pricing.astro
/400-sf-audit global
```
