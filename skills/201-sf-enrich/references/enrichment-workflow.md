...
scope: 201-sf-enrich-enrichment-workflow
owner: unknown
confidence: high
risk_level: high
security_impact: yes
...
linked_systems:
  ...
  - skills/201-sf-enrich/references/enrichment-workflow.md
depends_on:
...
supersedes: []
evidence:
  - "Extracted from skills/201-sf-enrich/SKILL.md during Compact ShipFlow Skill Instructions Phase 3."
...
This reference preserves the detailed pre-compaction instructions for `201-sf-enrich`. The top-level `SKILL.md` is now the activation contract; load this file only when the selected mode needs the detailed workflow, checklist, templates, provider routing, examples, or report details below.
