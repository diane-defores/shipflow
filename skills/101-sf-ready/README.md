...
`101-sf-ready` is a readiness gate for spec-driven work. It checks whether a spec is complete, unambiguous, aligned with the user story, testable, aware of linked systems, and proportionate on security. The output is a verdict: ready or not ready, with concrete reasons.
...
- before `102-sf-start` on non-trivial work
...
```bash
/101-sf-ready
/101-sf-ready specs/billing-rework.md
/101-sf-ready docs/specs/new-onboarding.md
```
...
- `100-sf-spec` to create or improve the spec
- `102-sf-start` after a ready verdict
- `103-sf-verify` after implementation
