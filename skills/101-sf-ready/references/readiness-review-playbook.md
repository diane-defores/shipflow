...
scope: 101-sf-ready-review-playbook
owner: Diane
confidence: high
risk_level: high
security_impact: yes
...
supersedes: []
evidence:
  - "2026-06-27 targeted hardening pass moved long readiness heuristics out of the 101-sf-ready activation contract while preserving local readiness gates."
  - "2026-06-26 batch A hardening audit identified 101-sf-ready body-size pressure as the clearest execution-fidelity risk in the current corpus."
next_review: "2026-07-04"
next_step: "/103-sf-verify 101-sf-ready execution-fidelity compaction"
---

# 101-sf-ready Readiness Review Playbook

## Purpose

This reference holds the detailed readiness heuristics for `101-sf-ready`.
...
- when the spec touches ShipFlow artifacts, skills, reports, technical docs,
  prompts, or user-facing product copy, it respects ShipFlow language doctrine
...
- can language doctrine confusion make the spec or related artifact easier to
  misread?
- does the test plan really let `103-sf-verify` judge compliance?
...
- Do not implement from `101-sf-ready`.
...
- Check active docs, ShipFlow language doctrine, design-system authority, and
