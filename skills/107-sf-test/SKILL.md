...
`107-sf-test` answers one question: `Quel résultat manuel observé faut-il enregistrer pour ce flow ?`
...
`107-sf-test` never invents results and needs user or tool evidence before logging success.
