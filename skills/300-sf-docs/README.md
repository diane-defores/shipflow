...
`300-sf-docs` documents what the code and proven context support. It should not invent features, guarantees, or business claims that are not backed by the repo or explicit context.
