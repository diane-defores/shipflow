...
`300-sf-docs` is the owner for project governance corpus creation, update, and audit.

- `300-sf-docs technical` owns technical governance layer bootstrapping/auditing.
- `300-sf-docs editorial` owns editorial/public-content governance bootstrapping/auditing.
- `300-sf-docs update` aligns docs drift and can route to technical/editorial bootstrap or audit.
- `300-sf-docs migrate-layout` owns legacy root ShipFlow artifact migration to canonical `shipflow_data/` paths.
- `300-sf-docs metadata` owns frontmatter migration/compliance for active ShipFlow artifacts.
