...
linked_systems:
  ...
  - skills/008-sf-end-user/references/onboarding-progress-overlay-pattern.md
depends_on:
...
supersedes: []
evidence:
  - "Operator request 2026-06-29: transform sf-onboarding into sf-end-user with UX/UI mode and keep onboarding as a playbook/reference."
next_review: "2026-07-29"
next_step: "/103-sf-verify 008-sf-end-user"
---
...
Use this playbook when `008-sf-end-user` is asked about onboarding, activation, setup guidance, first-run flows, first-success recovery, or feature adoption.
...
Route broad visual-system, component, layout, or token work to `006-sf-design`. Keep `008-sf-end-user` focused on the user's path, comprehension, state, recovery, and proof.
...
When the work needs a popup-style or stepped onboarding overlay, also load `skills/008-sf-end-user/references/onboarding-progress-overlay-pattern.md`.
