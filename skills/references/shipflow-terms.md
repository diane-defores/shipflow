...
| `#positioning` | Recenter on differentiation, category framing, and market angle | `$SHIPFLOW_ROOT/shipflow_data/business/gtm.md` |
| `#distribution` | Recenter on channels, reach, SEO, affiliates, and partner-led growth | `$SHIPFLOW_ROOT/shipflow_data/business/gtm.md` |
...
| `#freshness` | Recenter on whether the document or claim is still current enough to trust | `$SHIPFLOW_ROOT/shipflow_data/editorial/content-map.md` |
| `#traceability` | Recenter on linking decision, source, implementation, and proof | `$SHIPFLOW_ROOT/shipflow-spec-driven-workflow.md` |
...
| `#public-docs` | Recenter on public-facing docs, readability, and declared external surfaces | `$SHIPFLOW_ROOT/shipflow_data/editorial/content-map.md` |
| `#internal-docs` | Recenter on internal docs, operator truth, and execution-facing artifacts | `$SHIPFLOW_ROOT/shipflow_data/technical/context.md` |
