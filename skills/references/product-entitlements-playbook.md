...
Update this playbook when ShipFlow projects add a new billing provider, marketplace flow, app-store purchase flow, entitlement status, support runbook pattern, or database authorization pattern that changes the reusable doctrine.
