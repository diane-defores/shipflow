...
This reference defines the reusable ShipFlow loop for applying a bounded task list without losing the user story, context, progress state, or proof requirement.
...
- load the context files named by the work item, plus any required ShipFlow references
...
- required context files or required ShipFlow references are missing
