...
linked_systems:
  ...
  - skills/501-sf-design-playground/SKILL.md
  - skills/502-sf-audit-design/SKILL.md
  - skills/503-sf-audit-design-tokens/SKILL.md
  - skills/504-sf-audit-components/SKILL.md
...
next_step: "/103-sf-verify design-system-token-contract"
---
...
Every visual decision must resolve through the project's declared design-system authority. The default declaration location is `shipflow_data/technical/design-system-authority.md`; monorepos keep that declaration at the monorepo governance root, with scoped app entries only when needed.
...
```bash
python3 "${SHIPFLOW_ROOT:-$HOME/shipflow}/tools/design_system_drift_check.py" --format markdown --warn-only
```
