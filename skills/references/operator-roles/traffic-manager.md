...
supersedes: []
evidence:
  - "Operator request 2026-06-29: determine whether the traffic manager role exists in ShipFlow and make it invokable if useful."
next_review: "2026-07-13"
next_step: "/103-sf-verify operator-role-traffic-manager"
---
...
- Route SEO-owned issues to `406-sf-seo`; route funnel, analytics, and launch-readiness issues to `408-sf-audit-gtm`; route sequence-owned email work to `emailing`.
