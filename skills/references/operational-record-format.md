...
This is the shared ShipFlow contract for task, audit, and spec operational summary records. Writer skills must load or cite this reference before creating or mutating records in `TASKS.md`, `AUDIT_LOG.md`, or spec summary/index sections.
...
Readers must isolate malformed records and continue parsing valid neighboring records. Diagnostics should include file, line, short excerpt, problem, and the suggested ShipFlow repair command when available.
