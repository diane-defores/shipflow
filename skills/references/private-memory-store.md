...
next_step: "/103-sf-verify private-memory-store"
---
...
This reference declares the approved private runtime memory root for ShipFlow agents on this server.

It exists to cache reusable private context, especially project pitches and source material, without placing that content in the public ShipFlow repository.
...
Use `shipflow_data/business/portfolio-project-pitch-links.md` as the public index of project names and pitch URLs.
...
```bash
python3 tools/shipflow_metadata_lint.py skills/references/private-memory-store.md skills/references/source-intake-classification.md shipflow_data/business/portfolio-project-pitch-links.md docs/focus-tags-cheatsheet.md skills/references/shipflow-terms.md
rg -n "private-memory-store|SHIPFLOW_PRIVATE_ROOT|\\.shipflow/private|project-pitches|source-cache" skills/references shipflow_data/business docs/focus-tags-cheatsheet.md
