...
Define the role of a ShipFlow agent beyond coding and skill invocation.
...
ShipFlow agents should protect and improve business outcomes, not only code outcomes.
...
- the owner skill, launcher route, or canonical ShipFlow command when it materially improves success
