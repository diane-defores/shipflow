...
supersedes: []
evidence:
  - "User request 2026-06-10: create a ShipFlow skill to manage product and technical parity across platforms."
next_review: "2026-07-10"
next_step: "Use with /602-sf-platform-parity on a real project scope."
---

# Platform Parity Matrix

Use this reference when `602-sf-platform-parity` needs durable evidence or handoff detail.
...
- `100-sf-spec`: new parity chantier needed
- `001-sf-build`: implementation can start from a clear contract
- `107-sf-test`: native or device QA is the primary missing proof
- `103-sf-verify`: readiness and coherence need verification
- `300-sf-docs`: claim or operator guidance correction
- `005-sf-ship`: only after verification with bounded ship scope
