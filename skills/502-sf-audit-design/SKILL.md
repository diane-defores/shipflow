...
- `DEEP MODE`: launch specialist skills (`503-sf-audit-design-tokens`, `504-sf-audit-components`, `409-sf-audit-a11y`) per instructions in `audit-gates.md`.
