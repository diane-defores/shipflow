...
> Specialist profond sur les 4 systèmes de design tokens : **theme, typography, spacing, motion**. Appelée par `502-sf-audit-design` en deep mode ou utilisée en standalone.
...
- **Appelée par** : `502-sf-audit-design` en deep mode (Agent tool, en parallèle avec `504-sf-audit-components` et `409-sf-audit-a11y`).
- **Recommande** : `501-sf-design-playground` comme amélioration prioritaire si aucune page de preview des design tokens n'est détectée.
- **Orchestrée par** : `006-sf-design` quand l'audit déclenche une migration multi-pages, une centralisation appliquée à tout le site, ou une preuve visuelle de non-régression.
...
# Cross-projet
/503-sf-audit-design-tokens global
```
