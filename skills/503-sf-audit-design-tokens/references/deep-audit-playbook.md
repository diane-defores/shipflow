...
supersedes: []
evidence:
  - "Extracted from the activation body of `503-sf-audit-design-tokens` during aggregate compaction phase 1 so deep audit detail no longer competes with the first-screen contract."
next_step: "none"
---
...
Use the same cross-project pattern as `502-sf-audit-design`:
