...
supersedes: []
evidence:
  - "Spec specs/108-sf-browser-general-browser-verification-skill.md requires a compact evidence reference for 108-sf-browser."
next_review: "2026-06-02"
next_step: "/103-sf-verify 108-sf-browser General Browser Verification Skill"
---
...
This reference keeps `108-sf-browser` concise while defining how browser evidence should be collected, summarized, redacted, and reported.
...
| Missing preview or deploy status | `/405-sf-prod [project or URL]` |
| Preview-push project with unshipped changes | `/005-sf-ship [scope]`, then `/405-sf-prod [project or URL]` |
| Full manual user flow | `/107-sf-test [scope]` |
| Narrow actionable bug | `/106-sf-fix [summary]` |
| Non-trivial cross-system follow-up | `/100-sf-spec [title and compact context]` |
| Verification evidence gap | `/103-sf-verify [scope]` |
