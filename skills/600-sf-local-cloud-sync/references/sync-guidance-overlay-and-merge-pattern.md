...
evidence:
  ...
  - "Existing 600-sf-local-cloud-sync references covered doctrine and checklists but not a complete reusable implementation blueprint."
...
Preserve the SocialGlowz post-auth sync experience as the canonical ShipFlow reference for local-to-cloud sync guidance.
