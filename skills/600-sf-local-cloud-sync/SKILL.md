...
Because this skill can expose data-loss, tenant-boundary, privacy, and security work, evaluate whether non-trivial follow-up needs `/100-sf-spec` before implementation.
...
`600-sf-local-cloud-sync` is the ShipFlow entrypoint for local-first data becoming account-backed cloud data.
