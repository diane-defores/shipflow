...
`200-sf-redact` creates blog posts, educational guides, and founder-style editorials from the project context. It reads the available brand, business, and author documents, researches the topic, plans the angle, and produces content that is meant to be publishable, not generic filler.
...
```bash
/200-sf-redact
/200-sf-redact "3 blog"
/200-sf-redact "1 editorial AI for educators"
```
...
- `203-sf-research` for deeper source gathering first
- `201-sf-enrich` to upgrade existing content
- `300-sf-docs` for non-marketing documentation work
