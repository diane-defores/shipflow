...
`206-sf-audit-copy` reviews user-facing copy on a page or across a project. It looks at clarity, tone, grammar, CTA quality, microcopy, trust signals, and whether the language matches what the product really does.
...
```bash
/206-sf-audit-copy
/206-sf-audit-copy src/pages/index.astro
/206-sf-audit-copy global
```
...
- `207-sf-audit-copywriting` for conversion strategy and persuasion
- `408-sf-audit-gtm` for broader market and funnel readiness
- `300-sf-docs` when product changes require documentation updates
