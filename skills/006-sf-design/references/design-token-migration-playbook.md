...
supersedes: []
evidence:
  - "006-sf-design compaction moved token migration and visual shortcut doctrine out of SKILL.md."
next_review: "2026-07-29"
next_step: "/103-sf-verify 006-sf-design token migration"
---
...
Define the token centralization and migration doctrine used by `006-sf-design`.
