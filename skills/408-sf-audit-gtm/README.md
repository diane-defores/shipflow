...
`408-sf-audit-gtm` inspects a page or full project through a go-to-market lens. It checks positioning, conversion architecture, trust, objection handling, pricing transparency, analytics, and launch readiness.
...
```bash
/408-sf-audit-gtm
/408-sf-audit-gtm src/pages/pricing.astro
/408-sf-audit-gtm global
```
