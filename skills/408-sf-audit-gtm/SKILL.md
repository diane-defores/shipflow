...
- `rg -n "Trace category|Process role|Chantier Potential|Report Modes|positioning|funnel|trust|analytics|references/" skills/408-sf-audit-gtm/SKILL.md`
