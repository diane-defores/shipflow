...
next_step: "Use with /sf-platform-parity on a real project scope."
---

# Platform Parity Matrix

Use this reference when `sf-platform-parity` needs durable evidence or handoff detail.
...
- `sf-spec`: new parity chantier needed
- `sf-build`: implementation can start from a clear contract
- `sf-test`: native or device QA is the primary missing proof
- `sf-verify`: readiness and coherence need verification
- `sf-docs`: claim or operator guidance correction
- `sf-ship`: only after verification with bounded ship scope
