...
- FOLLOW-UP: route implementation, content, product, or GTM decisions to `/100-sf-spec` when findings cross chantier threshold.
...
- `rg -n "Trace category|Process role|Chantier Potential|demand|competition|monetization|GO / NO-GO|references/" skills/204-sf-market-study/SKILL.md`
