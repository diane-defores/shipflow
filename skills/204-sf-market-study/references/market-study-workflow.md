...
scope: 204-sf-market-study-market-study-workflow
owner: unknown
confidence: high
risk_level: high
security_impact: yes
...
linked_systems:
  ...
  - skills/204-sf-market-study/references/market-study-workflow.md
depends_on:
...
supersedes: []
evidence:
  - "Extracted from skills/204-sf-market-study/SKILL.md during Compact ShipFlow Skill Instructions Phase 3."
...
This reference preserves the detailed pre-compaction instructions for `204-sf-market-study`. The top-level `SKILL.md` is now the activation contract; load this file only when the selected mode needs the detailed workflow, checklist, templates, provider routing, examples, or report details below.
...
→ Lancer /305-sf-init pour générer ce fichier, ou /300-sf-docs migrate-layout si un ancien BUSINESS.md existe à la racine.
```
