...
- `102-sf-start` to execute the named task end to end
- `701-sf-backlog` to park work that should not stay active
- `703-sf-review` to summarize what happened in the session
