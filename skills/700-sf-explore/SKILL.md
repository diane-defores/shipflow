...
`700-sf-explore` reste `non-applicable` pour la trace de specs (aucune ecriture de `Skill Run History`), mais peut produire un artifact durable `exploration_report`.
...
- Sinon, ecrire si l'exploration est substantielle (au moins 2 criteres vrais):
  ...
  - handoff `/100-sf-spec` recommande
...
- **Mener à l'action** : "Prêt à coder ? Lance `/102-sf-start`"
...
**Prochaine étape :**
- Démarrer le travail : /102-sf-start <tâche>
