...
Evaluate `008-sf-end-user` when work adds or changes a user-facing feature, setup flow, first-run state, empty state, permission, integration, settings path, multi-step workflow, public promise, docs/support expectation, or behavior a beginner might not discover.
...
[Onboarding suggestion: /008-sf-end-user <feature or flow>]
