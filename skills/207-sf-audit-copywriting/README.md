...
`207-sf-audit-copywriting` evaluates persuasion strategy across a page or full project. It looks at persona fit, value proposition, objections, funnel sequencing, emotional progression, and conversion logic.
...
```bash
/207-sf-audit-copywriting
/207-sf-audit-copywriting src/pages/pricing.astro
/207-sf-audit-copywriting global
```
...
- `206-sf-audit-copy` for wording, clarity, and microcopy
- `408-sf-audit-gtm` for market-facing launch readiness
- `204-sf-market-study` when the real problem is demand or positioning uncertainty
