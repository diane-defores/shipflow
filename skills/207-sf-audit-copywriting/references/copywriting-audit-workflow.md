...
scope: 207-sf-audit-copywriting-copywriting-audit-workflow
owner: unknown
confidence: high
risk_level: high
security_impact: yes
...
linked_systems:
  ...
  - skills/207-sf-audit-copywriting/references/copywriting-audit-workflow.md
depends_on:
...
supersedes: []
evidence:
  - "Extracted from skills/207-sf-audit-copywriting/SKILL.md during Compact ShipFlow Skill Instructions Phase 2."
...
This reference preserves the detailed pre-compaction instructions for `207-sf-audit-copywriting`. The top-level `SKILL.md` is now the activation contract; load this file only when the selected mode needs the detailed workflow, checklist, templates, or examples below.
...
source_skill: "207-sf-audit-copywriting"
...
## Distinction avec 206-sf-audit-copy
...
> Généré par : /207-sf-audit-copywriting
