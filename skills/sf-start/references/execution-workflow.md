...
This reference preserves the detailed lifecycle workflow for `sf-start`. Load it after the compact `SKILL.md` activation contract when this skill is invoked.
