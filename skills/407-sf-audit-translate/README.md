...
`407-sf-audit-translate` audits translation quality and i18n implementation for a page or a full project. It checks completeness, terminology consistency, locale-specific SEO, hardcoded strings, formatting, and routing behavior.
...
```bash
/407-sf-audit-translate
/407-sf-audit-translate src/pages/fr/pricing.astro
/407-sf-audit-translate global
/407-sf-audit-translate sync
/407-sf-audit-translate apply src/i18n
```
...
- `206-sf-audit-copy` for localized copy quality
- `406-sf-audit-seo` for multilingual search and indexing issues
- `400-sf-audit` when translation quality is only one part of a wider release review
