...
This reference preserves the detailed lifecycle workflow for `sf-spec`. Load it after the compact `SKILL.md` activation contract when this skill is invoked.
