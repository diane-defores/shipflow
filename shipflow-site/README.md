...
This site is the public explanation, docs, FAQ, pricing hypothesis, blog, and skill-discovery surface for ShipFlow. It should stay aligned with the repository README, `shipflow_data/editorial/content-map.md`, and `shipflow_data/technical/public-site-and-content-runtime.md`.
