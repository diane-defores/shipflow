---
title: "sf-local-cloud-sync"
slug: "sf-local-cloud-sync"
...
example_prompts:
  ...
  - "/sf-local-cloud-sync audit whether account creation can preserve local data"
  - "/sf-local-cloud-sync create the sync contract before we promise reinstall recovery"
argument_modes:
...
limits:
  ...
  - "It does not replace sf-end-user for broad activation and setup guidance"
...
Use `sf-local-cloud-sync` when the core question is whether local user data can
