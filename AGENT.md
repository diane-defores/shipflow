...
docs_impact: "yes"
linked_systems: ["CLAUDE.md", "CONTEXT.md", "CONTEXT-FUNCTION-TREE.md", "CONTENT_MAP.md", "README.md", "skills/references/canonical-paths.md"]
depends_on: []
supersedes: []
evidence: ["Repository structure and active context docs", "CONTENT_MAP.md added as the content routing artifact", "Canonical path resolution added for ShipFlow-owned tools and references"]
