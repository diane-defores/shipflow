...
The complete-corpus checkout is sparse and includes only the skill/runtime corpus: `skills/`, `templates/`, `tools/`, `shipflow_data/`, `docs/`, `local/`, and `bugs/`. It excludes `site/`, `tui/`, archives, research folders, generated builds, and dependency directories.
